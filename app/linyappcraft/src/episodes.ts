...
//       https://youtube.com/shorts/AbcDef12345       → 'AbcDef12345' (short: true)
...
export interface Episode {
  ...
  desc?: string;     // 짧은 설명
  short?: boolean;   // 유튜브 Shorts(세로 영상)면 true
}

export const EPISODES: Episode[] = [
  { ep: 1, title: '리니와 도리의 첫 만남', videoId: 'G2z9l5mvgh0', desc: '가시 숲에서 시작되는 두 친구의 이야기', short: true },
...
// 리니와도리 유튜브 채널
export const CHANNEL_URL = 'https://youtube.com/channel/UCanyrzOtkE5gUG-beA8cn4Q';
